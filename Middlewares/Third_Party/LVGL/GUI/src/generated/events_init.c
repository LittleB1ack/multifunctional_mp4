...
static void screen_btn_1_event_handler (lv_event_t *e)
{
    ...
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_1, guider_ui.screen_1_del, &guider_ui.screen_del, setup_scr_screen_1, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 200, 200, true, true);
        break;
    }
    default:
        break;
...
static void screen_1_slider_1_event_handler (lv_event_t *e)
{
    ...
    {
        lv_obj_set_style_bg_color(guider_ui.screen_1_carousel_1, lv_color_hex(0xffea00), LV_PART_MAIN);
        lv_obj_set_style_bg_color(guider_ui.screen_1_carousel_1, lv_color_hex(0x00b3ff), LV_PART_MAIN);
        break;
    }
    default:
        break;
